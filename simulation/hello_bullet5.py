...
try:
    ...
    while True:
        for i in range(0,len(forward_targets_FR_BL)):
            ...
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["FR"]["shoulder"], controlMode=p.POSITION_CONTROL, targetPosition=target_FR_angle_shoulder, force=25)
            # Move front right femur
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["FR"]["femur"], controlMode=p.POSITION_CONTROL, targetPosition=target_FR_angle_femur, force=25)
            # Move front right knee
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["FR"]["knee"], controlMode=p.POSITION_CONTROL, targetPosition=target_FR_angle_knee, force=25)
            #------------------------------
            # Move front left shoulder
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["FL"]["shoulder"], controlMode=p.POSITION_CONTROL, targetPosition=target_FL_angle_shoulder, force=25)
            # Move front left femur
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["FL"]["femur"], controlMode=p.POSITION_CONTROL, targetPosition=target_FL_angle_femur, force=25)
            # Move front left knee
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["FL"]["knee"], controlMode=p.POSITION_CONTROL, targetPosition=target_FL_angle_knee, force=25)
            #------------------------------
            # Move back right shoulder
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["BR"]["shoulder"], controlMode=p.POSITION_CONTROL, targetPosition=target_BR_angle_shoulder, force=25)
            # Move back right femur
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["BR"]["femur"], controlMode=p.POSITION_CONTROL, targetPosition=target_BR_angle_femur, force=25)
            # Move back right knee
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["BR"]["knee"], controlMode=p.POSITION_CONTROL, targetPosition=target_BR_angle_knee, force=25)
            #------------------------------
            # Move back left shoulder
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["BL"]["shoulder"], controlMode=p.POSITION_CONTROL, targetPosition=target_BL_angle_shoulder, force=25)
            # Move back left femur
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["BL"]["femur"], controlMode=p.POSITION_CONTROL, targetPosition=target_BL_angle_femur, force=25)
            # Move back left knee
            p.setJointMotorControl2(bodyUniqueId=robotId, jointIndex=joint_ids["BL"]["knee"], controlMode=p.POSITION_CONTROL, targetPosition=target_BL_angle_knee, force=25)
            #------------------------------
